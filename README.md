...
![tests](https://img.shields.io/badge/tests-54%20passing-brightgreen?logo=pytest&logoColor=white)
...
- **Phase 1 — Skeleton:** ✅ an installable package with a strict layering
  ...
  a 4-command CLI, 54 tests that run in under a second with no download, and
